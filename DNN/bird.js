...
class Bird{
	...
	constructor(brain){
		...
		else
		{
			...
			// let layer = this.brain.add_layer(5,INPUT_LAYER);
			// layer = this.brain.add_layer(5,HIDDEN_LAYER,leaky_relu,layer);
	  //   	layer = this.brain.add_layer(2,OUTPUT_LAYER,leaky_relu,layer);
		}
		this.score = 0;
		this.fitness = 0;
		console.log("called");
